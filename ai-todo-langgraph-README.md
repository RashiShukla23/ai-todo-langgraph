# Tody — AI To-Do List Agent

Tody is a conversational to-do list app where you manage tasks through natural language instead of clicking buttons. Just type what you want and Tody handles the rest.
...
- Keeps a consistent "Tody" assistant persona throughout
...
The user sends a message, the LangGraph agent decides which tool to call (add/update/delete/list), the tool runs the corresponding PostgreSQL query, and Tody replies. Conversation state is checkpointed per session so context is never lost.
...
Tody: Done! Added "submit assignment" to your list.

You: Show all tasks
Tody: Here's what you have:
  1. submit assignment
  2. buy groceries

You: Delete buy groceries
Tody: Removed "buy groceries".
```
